...
import { LoadingPage, PageStub } from './components/ui';
...
// Route-level code splitting: heavy pages (maps, charts, terminal, OCR) load
// on demand — critical for Android/mobile startup time and data usage.
