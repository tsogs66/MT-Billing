...
const ANDROID_APK_URL =
  'https://github.com/tsogs66/MT-Billing/releases/download/android-latest/app-debug.apk';
const ANDROID_RELEASE_URL =
  'https://github.com/tsogs66/MT-Billing/releases/tag/android-latest';
      ...
      <div className="space-y-5 max-w-3xl">
        <div className="rounded-2xl border border-sky-500/35 bg-sky-500/10 p-4 sm:p-5">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              <div className="text-base font-bold text-slate-900">Windows installer</div>
              <p className="text-sm text-slate-600 mt-1 leading-relaxed">
                Install the full panel on Windows 10/11 or Server as a Windows service (API + UI on one port).
                Then set the PC as an <b>Edge</b> node below to sync with this hub.
              </p>
              <div className="mt-3 flex flex-wrap gap-2">
                <a
                  className="btn-primary inline-flex items-center gap-2 text-sm"
                  href="https://github.com/tsogs66/MT-Billing/releases/download/windows-latest/mt-billing-windows-x64.zip"
                  target="_blank"
                  rel="noreferrer"
                >
                ...
                <a
                  className="btn-secondary inline-flex items-center gap-2 text-sm"
                  href="https://github.com/tsogs66/MT-Billing/releases/tag/windows-latest"
                  target="_blank"
                  rel="noreferrer"
                >
                  <ExternalLink size={16} /> Release notes
              ...
              <ol className="mt-3 text-xs text-slate-500 space-y-1 list-decimal pl-4 leading-relaxed">
                <li>Unzip <code className="text-slate-700">mt-billing-windows-x64.zip</code>.</li>
                <li>Right-click <code className="text-slate-700">install.cmd</code> → Run as administrator.</li>
                <li>Open <code className="text-slate-700">http://127.0.0.1/</code> — sign in <code className="text-slate-700">admin</code> / <code className="text-slate-700">admin123</code>.</li>
                <li>Configure Edge sync below.</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-slate-500/35 bg-slate-500/10 p-4 sm:p-5">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              <div className="text-base font-bold text-slate-900">PC USB installer (Linux appliance)</div>
              <p className="text-sm text-slate-600 mt-1 leading-relaxed">
        ...
        <p className="text-sm text-slate-500 leading-relaxed">
          Install the full panel on a local PC (Windows installer, USB/flash, or normal install). Set this server as{' '}
